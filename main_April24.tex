...
\begin{itemize}
 ...
 \item The productivity of each generator depends on the age and efficiency of their technology
 \item In each period, a generator can choose to pay an adoption cost and draw a new efficiency value. It exits if its present value goes to zero
...
\begin{frame}{Years since latest update}
...
\begin{align*}
    ...
    \end{align*}
\end{frame}
\begin{frame}{Why relative Efficiency matters}
    \begin{itemize}
...
\hyperlink{updatespattern}{\beamerbutton{Update pattern}}
