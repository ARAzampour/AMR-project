...
c_a_new_vec     = c_a_new + (c_a_new_1st-c_a_new)*exp(linspace(0,-10,trans_t));
c_e_new_vec     = c_e_new + (c_e_new_1st-c_e_new)*exp(linspace(0,-10,trans_t));
...
e0_n_1st        = 0.8;
e0_n_vec        = e0_n + (e0_n_1st-e0_n)*exp(linspace(0,-10,trans_t));
...
[trans_prob_o,v_new_o,v_new_resh_o,dist_o,trans_matrix_n,p_e_n,...
    ...
    Two_tech_ss(a_grow,alpha,a_bar,beta,c_of_a,c_a_new,a_lamb,a_num_g,age_num,max_iter,...
