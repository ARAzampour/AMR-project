...
c_a_new = 15;   %%%% setting a different adoption cost for the new tech 
                %%%% might be a solution to get a two tech SS
...
c_of_e  = 5;
c_e_new = 10;   %%%% setting a different entry cost for the new tech 
                %%%% might be a solution to get a two tech SS
dem_tol = 0.01;
