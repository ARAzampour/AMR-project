...
%%% Use one common electricity-price realization in every steady state and
%%% transition so equal mean prices imply equal static profit problems.
n_PE = 50;
...
try
    ...
    e0_n_1st,e0_o,e_n_eps,e_o_eps,rho_p_n,sigma_p_n,rho_p_o,sigma_p_o,rho,age_reduc,exo_exit,P_E_grid_norm);
...
try 
    ...
    [trans_prob_o1,v_new_o1,v_new_resh_o1,dist_o1,trans_matrix_n1,p_e_n1,cap_contemp_n1,eff_n_final1,...
        ...
        e_n_eps,e_o_eps,rho_p_n,sigma_p_n,rho_p_o,sigma_p_o,rho,age_reduc,exo_exit,P_E_grid_norm);
...
try
    ...
    [trans_prob_o_all3,v_new_resh_o_all3,dist_o_all3,measure_vec_o3,p_e_o_vec3,input_all_o3,...
        ...
        e_max,gamma,init_input_n,init_input_o,penalty_o,penalty_n,penalty_p,d0_gr,...
        rho_p_n,sigma_p_n,rho_p_o,sigma_p_o,"checkpoint_ss_gas_coal_3rdMIT",P_E_grid_norm);
