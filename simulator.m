function error = simulator(a_grow,alpha,a_bar,beta,c_of_a,c_a_new,...
        ...
        e0_n,e0_o,e_n_eps,e_o_eps,rho_p_n,sigma_p_n,rho_p_o,sigma_p_o,rho,age_reduc,exo_exit,e_max,gamma,rat,...
...
[trans_prob_old,~,~,dist_o,trans_matrix_n,p_e_n,cap_contemp_new,eff_n_final,...
        ...
        e0_n,e0_o,e_n_eps,e_o_eps,rho_p_n,sigma_p_n,rho_p_o,sigma_p_o,rho,age_reduc,exo_exit,e_max,gamma);
