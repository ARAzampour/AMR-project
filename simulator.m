...
[trans_prob_old,~,~,dist_o,trans_matrix_n,p_e_n,cap_contemp_new,eff_n_final,...
        ...
        v_tol,dist_tol,rat*fco_o,rat*fco_n,e_p,d_0,rat*c_of_e,rat*c_e_new,dem_tol,tech_dist,...
...
mean_eff_model  = (dist_n*eff_grid_expan(:)*tech_dist+dist_o*eff_grid_expan(:))/...
    sum(dist_n+dist_o);
